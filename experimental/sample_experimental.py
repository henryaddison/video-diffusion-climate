import torch
from video_diffusion_pytorch_experimental import Unet3D, GaussianDiffusion, num_to_groups
...
checkpoint = torch.load(f"/user/work/cj19328/results_transform_0.1_lr_decay/model-{MILESTONE}.pt")
...
for batch_size in batch_sizes:
    ...
    torch.save(samples, f"/user/home/cj19328/samples_transform_0.1_lr_decay.pt")